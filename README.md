...
const CONFIG = {
  ...
  /**
   * If you are deploying to https://<USERNAME>.github.io/, for example your repository is at https://github.com/eprilian/eprilian.github.io, set base to '/'.
    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: [], // These projects will not be displayed. example: ['eprilian/my-project1', 'eprilian/my-project2']
        },
      },
      manual: {
  ...
  blog: {
    ...
    username: 'eprilian', // to hide blog section, keep it empty
...
const CONFIG = {
  ...
  social: {
    ...
    x: 'arif_szn',
    mastodon: 'eprilian@mastodon.social',
    researchGate: '',
    facebook: '',
    instagram: '',
    reddit: '',
